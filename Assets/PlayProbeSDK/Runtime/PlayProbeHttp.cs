...
{
    /// <summary>
    /// Builds the UnityWebRequests the SDK sends. Internal: these carry the session token, and a game
    /// has no reason to construct PlayProbe requests by hand.
    /// </summary>
    internal static class PlayProbeHttp
    {
